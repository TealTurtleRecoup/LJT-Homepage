...
- **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond** (Arxiv, 2025)  
  *First author* — Yuanxiang Fan, Zhuo Jiang, Han Ding, Yongyi Hu, Chi Zhang, Yiqi Shi, Shitong Weng, Aili Chen, Shiqi Chen, Yunan Huang, Mozhi Zhang, Pengyu Zhao, Junjie Yan, Junxian He

- **On the Perception Bottleneck of VLMs for Chart Understanding** (Arxiv, 2025)  
  *First author* — Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He

**2024**
- **On the Universal Truthfulness Hyperplane Inside LLMs** (EMNLP 2024)  
  *First author* — Shiqi Chen, Yu Cheng, Junxian He
